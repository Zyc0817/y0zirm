    ...
    <div class="foods-wrapper" v-el:food-wrapper>
      <ul>
        <li v-for="item in goods" class="food-list food-list-hook">
          ...
          <ul>
            <li @click="selectFood(food,$event)" v-for="food in item.foods" track-by="$index"
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      ...
      _initScroll() {
        this.menuScroll = new BSroll(this.$els.menuWrapper, {
          click: true
        });

        this.foodsScroll = new BSroll(this.$els.foodWrapper, {
          click: true,
          probeType: 3
        });
